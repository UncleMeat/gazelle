...
class feed
{
    public $UseSSL = false; // If we're using SSL for blog and news links
    ...
    public function torrent($Title, $Description, $Page, $DownLink, $InfoHash, $TorrentName, $TorrentSize, $ContentSize, $ContentSizeHR, $Creator, $Domain, $Category='', $Tags='')
    {
        $Date = date("r");
