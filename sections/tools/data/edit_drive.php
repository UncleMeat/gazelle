...
/* if(!$_REQUEST['body'] || strlen($_REQUEST['body'])<1 ) {
  error("Error: description was not provided");
  } */
...
if ($_REQUEST['submit']=='Start Donation Drive') {
...
} else {        // if ($state=='notstarted' ) {     //elseif ($_REQUEST['submit']=='Save Changes') {
    ...
    if ($_REQUEST['submit']=='Finish Donation Drive') {
        ...
        //if ($eur_rate=='0') error("The site was unable to get an exchange rate from the MtGox website, cannot proceed!");
