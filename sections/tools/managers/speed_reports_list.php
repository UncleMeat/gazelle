...
?> 
                    <tr class="rowb">
                        <td class="center" colspan="6">no users on watch list</td>
                    </tr>
<?
            } else {
...
<? }  ?>
    ...
    <script type="text/javascript">
        function change_view(){
            ...
            location.href = "tools.php?action=cheats&viewspeed="+selSpeed;
        }
    </script>
    <br/>
<?
