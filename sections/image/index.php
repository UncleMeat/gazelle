...
if (isset($_GET['avatar'])) {
    ...
    if (strlen($Data)>1024*1024 || $Height>400) {
        ...
        if (strlen($Data2)>1024*1024 || image_height($Type, $Data2)>400) {
...
[b]Avatars must not exceed 1MB or be vertically longer than 400px. [/b]
