                ...
                <table cellpadding="3" cellspacing="1" border="0" class="border" width="100%">              
                    <tr>
                        ...
                        <td>
                            ...
                            <input name="anonymous" value="0" type="radio"<? if($IsAnon!=1) echo ' checked="checked"';?>/> Show uploader name&nbsp;&nbsp;
                            <input name="anonymous" value="1" type="radio"<? if($IsAnon==1) echo ' checked="checked"';?>/> Hide uploader name (Anonymous)&nbsp;&nbsp;
