...
write_group_log($GroupID, $TorrentID, $LoggedUser['ID'], "deleted $Name (".number_format($Size/(1024*1024), 2)." MB, ".strtoupper($InfoHash[1]).") for reason: ".$_POST['reason']." ".$_POST['extra'], 0);
